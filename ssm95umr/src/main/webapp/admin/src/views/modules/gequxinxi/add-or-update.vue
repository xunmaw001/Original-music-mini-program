<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="歌曲名称" prop="gequmingcheng">
          <el-input v-model="ruleForm.gequmingcheng" 
              placeholder="歌曲名称" clearable  :readonly="ro.gequmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="歌曲名称" prop="gequmingcheng">
              <el-input v-model="ruleForm.gequmingcheng" 
                placeholder="歌曲名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="歌曲类型" prop="gequleixing">
          <el-select v-model="ruleForm.gequleixing" placeholder="请选择歌曲类型">
            <el-option
                v-for="(item,index) in gequleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="歌曲类型" prop="gequleixing">
	      <el-input v-model="ruleForm.gequleixing"
                placeholder="歌曲类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="歌手" prop="geshou">
          <el-select v-model="ruleForm.geshou" placeholder="请选择歌手">
            <el-option
        ...
        <el-form-item class="input" v-if="type!='info'"  label="时长" prop="shizhang">
          <el-input v-model="ruleForm.shizhang" 
              placeholder="时长" clearable  :readonly="ro.shizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="时长" prop="shizhang">
              <el-input v-model="ruleForm.shizhang" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="发行方" prop="faxingfang">
          <el-input v-model="ruleForm.faxingfang" 
              placeholder="发行方" clearable  :readonly="ro.faxingfang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发行方" prop="faxingfang">
              <el-input v-model="ruleForm.faxingfang" 
                placeholder="发行方" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="版权方" prop="banquanfang">
          <el-input v-model="ruleForm.banquanfang" 
              placeholder="版权方" clearable  :readonly="ro.banquanfang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="版权方" prop="banquanfang">
              <el-input v-model="ruleForm.banquanfang" 
                placeholder="版权方" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="歌词" prop="geci">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.geci" label="歌词" prop="geci">
                    <span v-html="ruleForm.geci"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gequmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='gequleixing'){
            this.ruleForm.gequleixing = obj[o];
	    this.ro.gequleixing = true;
            continue;
          }
	            	            if(o=='fengmian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/gequleixing/gequleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.gequleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.geci = this.ruleForm.geci.replace(reg,'../../../ssm95umr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
