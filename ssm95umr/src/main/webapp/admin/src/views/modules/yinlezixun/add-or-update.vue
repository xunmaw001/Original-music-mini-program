        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                                                ...
                                                                                                <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资讯来源" prop="zixunlaiyuan">
          <el-input v-model="ruleForm.zixunlaiyuan" 
              placeholder="资讯来源" clearable  :readonly="ro.zixunlaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资讯来源" prop="zixunlaiyuan">
              <el-input v-model="ruleForm.zixunlaiyuan" 
                placeholder="资讯来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="摘要" prop="zhaiyao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaiyao" label="摘要" prop="zhaiyao">
                    <span>{{ruleForm.zhaiyao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm95umr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yinlezixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yinlezixunCrossAddOrUpdateFlag = false;
                  this.parent.search();
