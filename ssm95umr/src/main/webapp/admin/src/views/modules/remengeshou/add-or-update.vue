<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="歌手姓名" prop="geshouxingming">
          <el-input v-model="ruleForm.geshouxingming" 
              placeholder="歌手姓名" clearable  :readonly="ro.geshouxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="歌手姓名" prop="geshouxingming">
              <el-input v-model="ruleForm.geshouxingming" 
                placeholder="歌手姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="歌手性别" prop="geshouxingbie">
        ...
        <div v-else>
          <el-form-item class="input" label="歌手性别" prop="geshouxingbie">
	      <el-input v-model="ruleForm.geshouxingbie"
                placeholder="歌手性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="歌曲流派" prop="gequliupai">
          <el-input v-model="ruleForm.gequliupai" 
              placeholder="歌曲流派" clearable  :readonly="ro.gequliupai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="歌曲流派" prop="gequliupai">
              <el-input v-model="ruleForm.gequliupai" 
                placeholder="歌曲流派" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="标签" prop="biaoqian">
              <el-input v-model="ruleForm.biaoqian" 
                placeholder="标签" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="热门歌曲" prop="remengequ">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.remengequ" label="热门歌曲" prop="remengequ">
                    <span>{{ruleForm.remengequ}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="歌手介绍" prop="geshoujieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.geshoujieshao" label="歌手介绍" prop="geshoujieshao">
                    <span v-html="ruleForm.geshoujieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	geshoujieshao : false,
            ...
            ruleForm: {
                  ...
                  gequliupai: [
                            { required: true, message: '歌曲流派不能为空', trigger: 'blur' },
                                    	                                                              ],
                  biaoqian: [
  ...
  methods: {
	...
	this.ruleForm.geshoujieshao = this.ruleForm.geshoujieshao.replace(reg,'../../../ssm95umr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `remengeshou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.remengeshouCrossAddOrUpdateFlag = false;
                  this.parent.search();
