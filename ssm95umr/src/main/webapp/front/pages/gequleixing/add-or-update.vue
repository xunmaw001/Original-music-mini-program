	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`gequleixing`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																												if(this.ruleForm.id){
					await this.$api.update(`gequleixing`, this.ruleForm);
				}else{
					await this.$api.add(`gequleixing`, this.ruleForm);
				}
