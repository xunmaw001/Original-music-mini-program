<template>
	<view class="content">
		<view class="forget-bg">
			<view class="forget-card" :style='{"boxShadow":"0 0 0px #59f43e","backgroundColor":"rgba(51, 153, 153, 0.37)","borderColor":"rgba(51, 153, 153, 1)","borderRadius":"8rpx","borderStyle":"solid","borderWidth":"2rpx"}'>
				<view class="forget-input forget-margin-b">
					<input v-model="username" :style='{"borderColor":"rgba(248, 176, 9, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' type="text" placeholder="请输入您的账号" />
				</view>
		...
		<view class="forget-btn">
			<button class="landing" :style='{"borderColor":"#ccc","backgroundColor":"rgba(248, 176, 9, 1)","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' @tap="onResetPass" type="primary">重置密码</button>
		</view>
	</view>
</template>
