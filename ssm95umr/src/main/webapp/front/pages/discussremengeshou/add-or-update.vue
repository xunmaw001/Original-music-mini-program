	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussremengeshou`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discussremengeshou`, this.ruleForm);
				}else{
					await this.$api.add(`discussremengeshou`, this.ruleForm);
				}
