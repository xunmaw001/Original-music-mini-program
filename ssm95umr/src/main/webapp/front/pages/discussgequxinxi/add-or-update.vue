	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussgequxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discussgequxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discussgequxinxi`, this.ruleForm);
				}
